...
public class ServiceBuilder extends DTOCodeBuilder {
    public ServiceBuilder(Map buildConfig, List<Map> columns){
    ...
    public Map<String, Object> createMap(Map buildConfig, List<Map> columns, Map<String, Object> map) {
        ...
        String url = this.getFilePath(classPath, buildConfig.get("name") + "Service.java");
