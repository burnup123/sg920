 ...
 */
@RestController
@RequestMapping(value = "/api/v1/orderProduct")
public class OrderProductRestController extends BaseController{
    ...
    /**
     * 保存数据
     * url: {ctx}/api/v1/orderProduct/save
     * type: orderProduct
     */
    ...
    */
    ...
    /**
    * 根据ID，获取单个
    * url: {ctx}/api/v1/orderProduct/fetch/{id}
    * type: get
    */
    @RequestMapping(value = "/fetch/{id}", method = RequestMethod.GET)
    public Object find(@PathVariable("id") String id) throws Exception {
        try {
            Map map = orderProductService.fetch(id);
    ...
    /**
    * 根据条件，获取多个
    * url: {ctx}/api/v1/orderProduct/finds
    * type: get
    */
    @RequestMapping(value = "/find", method = RequestMethod.GET)
    public Object find() throws Exception {
        try {
            List list = orderProductService.find(this.getParamData(), null);
    ...
    /**
    * 根据条件，分页获取多个
    * url: {ctx}/api/v1/orderProduct/query
    * type: get
    */
    ...
    public Object query(@RequestParam(value = "size") int size,@RequestParam(value = "page") int page) throws Exception {
        try {
            ...
            Long count = orderProductService.count(terms);
            List list = orderProductService.page(pageRequest, terms, null);
            Map ret = new HashMap();
            ret.put("total",count);
            ret.put("rows",list);
    ...
    /**
    * 统计数量
    * url: {ctx}/api/v1/orderProduct/count
    * type: get
    */
    @RequestMapping(value = "/count", method = RequestMethod.GET)
    public Object count(HttpServletRequest request) throws Exception {
        try {
            return ReturnUtil.getSucessInfo(orderProductService.count(this.getParamData()));
        } catch (Exception e) {
            logger.error(e.getMessage(), e);
            return ReturnUtil.getErrorInfo(e.getMessage());
        }
