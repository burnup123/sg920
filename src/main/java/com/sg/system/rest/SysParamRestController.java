 ...
 */
@RestController
@RequestMapping(value = "/api/v1/sysParam")
public class SysParamRestController extends BaseController{
    ...
    */
    ...
    /**
    * 根据条件，获取多个
    * url: {ctx}/api/v1/sysParam/finds
    * type: get
    */
    @RequestMapping(value = "/find", method = RequestMethod.GET)
    public Object find() throws Exception {
        try {
            List list = sysParamService.find(this.getParamData(), null);
    ...
    */
    ...
    public Object query(@RequestParam(value = "size") int size,@RequestParam(value = "page") int page) throws Exception {
        try {
            ...
            Long count = sysParamService.count(terms);
            List list = sysParamService.page(pageRequest, terms, null);
            Map ret = new HashMap();
            ret.put("total",count);
            ret.put("rows",list);
    ...
    /**
    * 统计数量
    * url: {ctx}/api/v1/sysParam/count
    * type: get
    */
    @RequestMapping(value = "/count", method = RequestMethod.GET)
    public Object count(HttpServletRequest request) throws Exception {
        try {
            return ReturnUtil.getSucessInfo(sysParamService.count(this.getParamData()));
        } catch (Exception e) {
            logger.error(e.getMessage(), e);
            return ReturnUtil.getErrorInfo(e.getMessage());
        }
